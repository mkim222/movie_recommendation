...
# Get the absolute path to the directory containing the Streamlit app
app_dir = os.path.dirname(os.path.abspath(__file__))

# Load the movies from the pickle file
movies_path = os.path.join(app_dir, 'movies.pickle')
try:
    with open(movies_path, 'rb') as f:
        movies = pickle.load(f)
except IOError:
    st.error("Error opening file. Please check file path and permissions.")
...
# Load the movies from the pickle file
cosine_sim_path = os.path.join(app_dir, 'cosine_sim.pickle')
try:
