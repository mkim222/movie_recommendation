...
#movies = pickle.load(open('/Users/minsookim/Desktop/Programming Language/Python/Machine Learning/Project/movies.pickle', 'rb'))
#cosine_sim = pickle.load(open('/Users/minsookim/Desktop/Programming Language/Python/Machine Learning/Project/cosine_sim.pickle', 'rb'))

##################################################################################
import requests
import pickle

# Replace this with the public link to the file on the cloud storage service
file_url1 = 'https://drive.google.com/file/d/1IV7hw3jWCZ2G5FVF1D-yzl6dLCytFSty/view?usp=sharing'

# Download the file using the requests library
response1 = requests.get(file_url1)
cosine_sim = pickle.loads(response1.content)

file_url2 = 'https://drive.google.com/file/d/1oADuqC0TyAjvsIPy-0gbMmDOMzg4tn2m/view?usp=sharing'

# Download the file using the requests library
response2 = requests.get(file_url2)
movies = pickle.loads(response2.content)
##################################################################################
